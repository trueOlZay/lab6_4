...
public class City implements Comparable<City>, Serializable{
    ...
    public String toLanguageString(ResourceBundle currentBundle) {
        return String.format(currentBundle.getString("toStringCity"), id, name, coordinates.getX(),
                coordinates.getY(), creationDate, area, population, metersAboveSeaLevel, agglomeration, climate,
                government, governor.getBirthday());
    }
}
